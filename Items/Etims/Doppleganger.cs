...
namespace QwertysRandomContent.Items.Etims
{
    public class Doppleganger : ModItem
    {
        ...
        public override bool NewPreReforge()
        {
            ...
            {
                player.KillMe(PlayerDeathReason.ByCustomReason(player.name + " tampered with forces beyond " + (player.Male ? Language.GetTextValue("Mods.QwertysRandomContent.his") : Language.GetTextValue("Mods.QwertysRandomContent.her")) + " control!"), 1000, 0);
            }
            else
            {
