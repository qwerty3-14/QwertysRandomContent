...
namespace QwertysRandomContent.Items.HydraItems
{
	...
	public class HydraJavelinP : ModProjectile
	{
		public override void SetStaticDefaults()
		{
		...
		public override void Kill(int timeLeft)
		{
            ...
            if (projectile.owner == Main.myPlayer)
            {
                int item =
                Main.rand.Next(18) == 0
                    ? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<HydraJavelin>())
                    : 0;
