...
namespace QwertysRandomContent.Items.Weapons.Crimtane
{
	...
	public class BloodSeekerP : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Blood Seeker");
		...
		public override void Kill(int timeLeft)
		{
            ...
            if (projectile.owner == Main.myPlayer)
            {
                int item =
                Main.rand.Next(18) == 0
                    ? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<BloodSeeker>())
                    : 0;
