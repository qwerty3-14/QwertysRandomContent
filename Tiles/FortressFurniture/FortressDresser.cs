...
{
	public class FortressDresser : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Fortress Dresser");
			AddMapEntry(new Color(162, 184, 185), name);
			dustType = mod.DustType("FortressDust");
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Fortress Dresser";
			dresserDrop = mod.ItemType("FortressDresser");
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				if (player.showItemIconText == chest)
				{
					player.showItemIcon2 = mod.ItemType("FortressDresser");
					player.showItemIconText = "";
				}
			}
			player.noThrow = 2;
