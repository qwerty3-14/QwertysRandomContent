...
namespace QwertysRandomContent.NPCs.HydraBoss
{
    public class Head6 : ModNPC
    {
           ...
           // npc.realLife = (int)npc.ai[0];
            ...
            if (Main.expertMode)
                ...
                else if (npc.rotation >= TargetDirection)
                {
                    ...
                    Vector2 moveTo = new Vector2(Hydra.Center.X + 100 + npc.ai[1], Hydra.Center.Y - (300f - npc.ai[2])) - npc.Center;
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            if (Main.netMode != 0)
            {
                ...
                spriteBatch.Draw(mod.GetTexture("NPCs/HydraBoss/HydraNeckBase"), neckOrigin - Main.screenPosition,
                    ...
                    spriteBatch.Draw(mod.GetTexture("NPCs/HydraBoss/Head2"), new Vector2(npc.Center.X - Main.screenPosition.X, npc.Center.Y - Main.screenPosition.Y),
                            npc.frame, drawColor, npc.rotation,
                            new Vector2(106 * 0.5f, 72 * 0.5f), 1f, SpriteEffects.None, 0f);
                    spriteBatch.Draw(mod.GetTexture("NPCs/HydraBoss/Head2_Glow"), new Vector2(npc.Center.X - Main.screenPosition.X, npc.Center.Y - Main.screenPosition.Y),
        ...
        public override void BossHeadSlot(ref int index)
        {
            ...
            index = NPCHeadLoader.GetBossHeadSlot(QwertysRandomContent.Head2Head);
