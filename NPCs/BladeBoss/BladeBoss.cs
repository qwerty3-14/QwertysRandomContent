...
namespace QwertysRandomContent.NPCs.BladeBoss
{
	...
	public class BladeBoss : ModNPC
	{
		...
		private int timer;
		private float preSwingPlayerDirection;
		private float preSwingPlayerDistance;
		private Vector2 hitSpot;
		private Vector2 hitSpot2;
		private Vector2 postSwingSpot;
		private float intialBoost = 10;
		private float directionOfAcceleration;
		private float acceleration = .1f;
		private int counter;
		private bool finishSwing;
		private float maxSpeed = 16;
		private bool toHitSpot2;
		private bool rocketMode;
		private bool thrust;
