...
namespace QwertysRandomContent.NPCs
{
    public class SharkWithFrickenLaserBeams : ModNPC
    {
        ...
        {
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ItemID.SharkFin, 1, false, 0, false, false);
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ItemID.DivingHelmet, 1, false, 0, false, false);
        }
    }
}